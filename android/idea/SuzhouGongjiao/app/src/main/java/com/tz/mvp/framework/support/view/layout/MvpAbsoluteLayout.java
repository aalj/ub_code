 ...
 *
 */
public abstract class MvpAbsoluteLayout<V extends MvpView, P extends MvpPresenter<V>>
		extends AbsoluteLayout implements ViewGroupMvpDelegateCallback<V, P>,
		MvpView {
	...
	public MvpAbsoluteLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public MvpAbsoluteLayout(Context context) {
		super(context);
	}
