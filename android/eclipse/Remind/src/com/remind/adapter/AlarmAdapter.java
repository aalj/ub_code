...
public class AlarmAdapter extends AdapterBase<MrAlarm>{
	...
	private void initViewData(int position,ViewHolder viewHolder, View convertView){
		...
		if(alarm.isRing()){
		    ...
		    Drawable drawable = resources.getDrawable(R.drawable.item_alarm_bg_selector);
			convertView.setBackgroundDrawable(drawable);
		}*/

		viewHolder.tvStationName.setText("目的地："+alarm.getPositionName());
	...
	protected View getExView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(ct).inflate(R.layout.item_remind_alarm, null);
