...
public class BuslineBaiduMapActivity extends BaseFragmentActivity implements BaiduMap.OnMapClickListener{
	...
	private void init(){
		...
		Object data=TransferData.getInstance().getData(DataType.BUSLINE);
		
		TransferData.getInstance().clearData();
		
		if(null==data){
			LogUtils.i(TAG, "传入的公交数据为空！");
			return;
		}
		
		MrBusLine busLine=(MrBusLine) data;
	...
	public void nodeClick(View v) {
		...
		popupText.setBackgroundResource(R.drawable.icon_popup);
